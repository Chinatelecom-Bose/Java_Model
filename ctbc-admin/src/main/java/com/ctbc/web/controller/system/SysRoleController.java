...
import com.ctbc.common.core.domain.entity.SysDept;
...
public class SysRoleController extends BaseController
{
    ...
    public AjaxResult edit(@Validated @RequestBody SysRole role)
    {
        ...
        if (roleService.updateRole(role) > 0)
        {
            ...
            // 刷新所有在线用户的权限
            refreshLoginUserPermission(role.getRoleId());
            return success();
        }
     ...
     * 刷新所有在线用户的权限
     */
    private void refreshLoginUserPermission(Long roleId)
    {
        try {
            ...
            for (String key : keys)
            {
                ...
                if (loginUser != null && loginUser.getUser() != null && StringUtils.isNotEmpty(loginUser.getUser().getRoles()))
                {
